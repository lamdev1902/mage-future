<?php
namespace MageDev\AssignProduct\Block\Adminhtml\Products\Edit\Tab;
...
{
    /**
     * @var \MageDev\AssignProduct\Model\Assign
     */
    protected $assign;
    /**
    ...
    public function __construct(
        ...
        \MageDev\AssignProduct\Model\ResourceModel\Product\CollectionFactory $productCollFactory,
    ...
    {
        parent::_construct();
        $this->setId('assign_grid_products');
    ...
    { 
        ...
        if(!empty($id))
        {
            $productDataItem = $this->assign->getAssignProductMatch($id);
            foreach($productDataItem as $productId)
            {
                $model = $this->productCollFactory->create()->addFieldToFilter('entity_id', $productId);

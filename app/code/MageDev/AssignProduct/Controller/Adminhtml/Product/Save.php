    ...
    */
    public function execute()
    {
        ...
        if (!empty($data['assign'])) {
            ...
            if(isset($data['assign']['entity_id'])){
                $model = $this->_objectManager->create(\MageDev\AssignProduct\Model\Assign::class)->load($data['assign']['entity_id']);
                ...
                $model = $this->_objectManager->create(\MageDev\AssignProduct\Model\Assign::class);
            }

            $model->setData($data['assign']);

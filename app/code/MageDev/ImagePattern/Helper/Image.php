...
use MageDev\Core\Helper\AbstractData;

/**
 * Class Image
 * @package MageDev\ImagePattern\Helper
 */
class Image extends AbstractData
{
    const TEMPLATE_MEDIA = 'magedev';
    const TEMPLATE_MEDIA_PATH = 'magedev';
    const TEMPLATE_MEDIA_TYPE_BY_BLOCK = 'byblock/image';
    /**
     * @var WriteInterface
     */
    ...
    {
        return trim(static::TEMPLATE_MEDIA . '/' . $type, '/');
    }
